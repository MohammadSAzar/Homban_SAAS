    ...
    NioApp.Calendar = function () {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            dayCellContent: function(info) {
                var dayDate = info.date;
                var dayStr = dayDate.getFullYear() + '/' +
                ...
                dayNumberEl.innerHTML = dayDate.getDate();
                ...
                taskBtnEl.onclick = function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    window.open('/task/create/?deadline=' + encodeURIComponent(dayStr), '_blank');
                };
